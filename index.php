            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="form.php" aria-expanded="false"><i class="fas fa-download"></i><span class="hide-menu ">Watchman - Out</span></li></a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid my-5">
                                        <div class="row mb-3">
                                            <div class="col-auto ">
                                                <button type="submit" class="btn btn-outline-success col-auto btn-rounded shadow font-weight-bold">View visitors</button>
                                            ...
                                            <div class="col-auto ">
                                                <button type="submit" class="btn btn-outline-success col-auto btn-rounded shadow font-weight-bold">Approval - Waiting</button>

                                            </div>
                                            <div class="col-auto ">
                                                <button type="submit" class="btn btn-outline-success col-auto btn-rounded shadow font-weight-bold">In Campus</button>

                                            </div>
                                            <div class=" pl-5 col-auto ">
                                                <button type="submit" class="btn btn-outline-success col-auto btn-rounded shadow font-weight-bold">Generate Report</button>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="table-responsive col-12 text-center   font-14 font-bold">
                                        <p>Place Table here</p>
                                    </div>
