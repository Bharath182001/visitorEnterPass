...
<body>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header d-flex justify-content-center align-items-center">
                                        ...
                                        <img src="logo.jpg" alt="Logo" class="logo-image me-3"><br>
    ...
    if (response.status === 404) {
        ...
        // Check exitApproval value
        if (response.data.exitApproval === 1) {
            $('#approvalButton').text('Allow out!').show();
        } else {
            // Instead of hiding the button, now we're changing it to "Report Staff" button
            $('#approvalButton').text('Report Staff').attr('data-mobile-number', response.data.mobileNumber).show();
        }
    ...
    if ($(this).text() === "Report Staff") {
        var mobileNumber = $(this).data('mobile-number');
        if (mobileNumber) {
            // Open the dial pad with the staff's mobile number
            window.location.href = "tel:" + mobileNumber;
        } else {
            alert("Staff mobile number not available.");
        }
    } else {
